...
namespace TrackerLibrary.DataAccess.TextHelper
{
    public static class TextConnectorProcessor
    {
        ...
        public static List<TournamentModel> ConvertToTournamentModel(this List<string> lines,
            string teamFileName, string peopleFileName, string prizesFileName)
        {
            // id = 0
            // TournamentName = 1
            // EntryFee = 2
        ...
        public static void SaveRoundsToFile(this TournamentModel model, string matchupFile, string matcupEntryFile)
        {
            foreach (List<MatchupModel> round in model.Rounds)
            {
                foreach (MatchupModel matchup in round)
                {
                    matchup.SaveMatchupToFile(matchupFile, matcupEntryFile);
                }
            }
        }
        ...
        public static void SaveMatchupToFile(this MatchupModel matchup, string matchupFile, string matcupEntryFile)
        {
            List<MatchupModel> matchups = GlobalConfig.MatchupFile.FullFilePath().LoadFile().ConvertToMatchupModels();
            ...
            {
                entry.SaveEntryToFile(matcupEntryFile);
            }
        ...
        public static void SaveEntryToFile(this MatchupEntryModel entry, string matchupEntryFile)
        {
            ...
            foreach (MatchupEntryModel entryModel in entries)
            {
                ...
                {
                    parent = entryModel.ParentMatchup.Id.ToString();
                }

                string teamCompeting = "";
                if (entryModel.TeamCompeting != null)
                {
                    teamCompeting = entryModel.TeamCompeting.Id.ToString();
                }


                lines.Add($"{ entryModel.Id },{ teamCompeting },{ entryModel.Score },{ parent }");
            }
